#!/usr/bin/env python3
"""Validate M2D-CLAP NPZ embeddings and preserve generation evidence."""
...
def main() -> int:
    ...
    if lock.get("status") != "complete":
        raise RuntimeError("M2D model lock is incomplete")
    ...
    with args.output.open("x", encoding="utf-8", newline="\n") as stream:
        ...
        stream.write("\n")
    print("M2D_EMBEDDING_VALIDATION_STATUS=complete")
