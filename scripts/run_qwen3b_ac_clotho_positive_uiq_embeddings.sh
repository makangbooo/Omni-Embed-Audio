...
CONFIG="${ROOT_DIR}/configs/eval/qwen3b_clotho_positive_uiq_embeddings.json"
BASE_PROTOCOL_CONFIG="${ROOT_DIR}/configs/eval/qwen3b_clotho_embeddings.json"
MODEL_LOCK="${MODEL_LOCK:-${ROOT_DIR}/results/model_locks/oea_qwen3b.json}"
RUN_ID="${RUN_ID:-oea_qwen3b_ac_clotho_positive_uiq_embeddings_seed42_$(date +%Y%m%d_%H%M%S)}"
