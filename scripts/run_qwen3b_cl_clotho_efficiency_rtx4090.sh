...
BENCHMARK_CONFIG="${ROOT_DIR}/configs/eval/qwen3b_cl_clotho_efficiency_rtx4090.json"
...
RUN_ID="${RUN_ID:-oea_qwen3b_clotho_rtx4090_efficiency_$(date +%Y%m%d_%H%M%S)}"
...
echo "[INFO] RTX 4090 efficiency benchmark completed: ${OUTPUT_DIR}/metrics.json"
