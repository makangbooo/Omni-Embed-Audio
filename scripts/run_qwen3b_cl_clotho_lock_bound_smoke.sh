...
PROTOCOL_CONFIG="${ROOT_DIR}/configs/eval/qwen3b_cl_clotho_lock_bound_smoke_embeddings.json"
MODEL_LOCK="${MODEL_LOCK:-${ROOT_DIR}/results/model_locks/oea_qwen3b_cl.json}"
RUN_ID="${RUN_ID:-oea_qwen3b_clotho_lock_bound_smoke_seed42_$(date +%Y%m%d_%H%M%S)}"
