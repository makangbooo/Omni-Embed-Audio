...
| EXP-16 | §5.3.2；表 17 | Negative UIQ 普通检索 | 630/542/409 条 negative rows | 4 CLAP + 6 OEA | mean R@5、R@10 | `[CODE][OBSERVED]` 三数据集 deterministic caption-identity 配对审计已达到 `1,581/1,581`；NPZ canonical evaluator 已实现；模型 negative query embedding 尚待运行 | strict PAPER target/HN 映射仍未发布；controlled 模型结果进行中 | C | IN_PROGRESS |
| EXP-17 | §3.3/§5.3.2；附录 L/M；表 4、17 | Hard-negative discrimination | 同 EXP-16 + target/HN 音频 ID | 4 CLAP + 6 OEA | Δ-Rank、HNSR、HNSR@10、TFR、TFR-HN@10 | `[CODE][OBSERVED]` deterministic released-caption identity 在 Clotho/AudioCaps/MECAT 分别取得 `542/542`、`630/630`、`409/409` 唯一配对；canonical evaluator 保存全量排名/哈希并禁止最近邻猜测 | 配对为 `[INFERRED]` controlled evidence；strict PAPER 显式 HN ID 仍未发布；十模型评测进行中 | C | IN_PROGRESS |
