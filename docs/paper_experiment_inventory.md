...
| EXP-10 | §5.1；表 2 | caption Text-to-Audio 完整基线 | AudioCaps 975、Clotho 1,045、MECAT 847（发布 UIQ 为 848，需澄清） | 4 CLAP + 3 vanilla LALM + 6 OEA | R@1/5/10 | 六个 OEA 变体在 Clotho 上均完成全量 embedding 和双协议 CPU 闭环；Qwen7B all-caption=`19.8852/44.6890/57.0909`、Qwen7B(+Cl)=`22.0287/48.5359/61.6459`，均用官方 OEA loader/metric source | AudioCaps 实际音频、MECAT 847/caption 口径、7 个 vanilla/CLAP baseline 和论文 caption 选择仍缺失 | C（六个 OEA/Clotho 分栏闭环完成） | IN_PROGRESS |
| EXP-11 | §5.2；表 3 | caption Text-to-Text 完整基线 | 同 EXP-10 captions/candidates | 同 EXP-10 | R@1/5/10 | 六个 OEA/Clotho 变体的 `[CODE]` seed0 与 `[INFERRED]` all-caption 均已分栏；Qwen7B(+Cl) seed0=`60.8612/72.8230/78.4689`、all-caption=`63.2344/74.9856/79.6555`，论文=`63.58/75.04/79.90`；未按接近度择优 | 其余模型/数据；论文 caption 选择、self-exclusion、tie 口径 `[MISSING]` | C（六个 OEA/Clotho 分栏闭环完成） | IN_PROGRESS |
