...
| EXP-11 | §5.2；表 3 | caption Text-to-Text 完整基线 | 同 EXP-10 captions/candidates | 同 EXP-10 | R@1/5/10 | Qwen3B-AC seed0 `[CODE]`=`61.3397/74.1627/79.3301`，all-caption `[INFERRED]`=`62.7943/73.8756/78.3158`，论文=`62.81/73.76/78.22`；与 Qwen3B-Cl 一样，全部协议均预声明并分栏，未按接近度择优 | 其余模型/数据；论文 caption 选择、self-exclusion、tie 口径 `[MISSING]` | C（两个 OEA 分栏闭环完成） | IN_PROGRESS |
