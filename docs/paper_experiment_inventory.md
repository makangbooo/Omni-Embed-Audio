...
| EXP-10 | §5.1；表 2 | caption Text-to-Audio 完整基线 | AudioCaps 975、Clotho 1,045、MECAT 847（发布 UIQ 为 848，需澄清） | 4 CLAP + 3 vanilla LALM + 6 OEA | R@1/5/10 | Qwen3B-Cl、Qwen3B-AC、Nemo3B-Cl 与 Nemo3B-AC 在 Clotho 上均完成全量 embedding 和双协议 CPU 闭环；Nemo3B-AC `[CODE]` all-caption=`18.2775/41.3206/54.2010`、seed0=`17.9904/41.6268/55.7895`，论文=`19.04/40.57/54.24` | 其余 9 个模型/权重、AudioCaps/MECAT 候选集、论文 caption 选择 `[MISSING]` | C（四个 OEA 分栏闭环完成） | IN_PROGRESS |
| EXP-11 | §5.2；表 3 | caption Text-to-Text 完整基线 | 同 EXP-10 captions/candidates | 同 EXP-10 | R@1/5/10 | Qwen3B-AC、Qwen3B-Cl、Nemo3B-Cl 与 Nemo3B-AC 的 `[CODE]` seed0 和 `[INFERRED]` all-caption 均已分栏；Nemo3B-AC seed0=`63.3493/74.8325/80.0957`、all-caption=`64.6316/74.9856/79.2536`，论文=`62.79/74.12/78.91`；全部协议均预声明，未按接近度择优 | 其余模型/数据；论文 caption 选择、self-exclusion、tie 口径 `[MISSING]` | C（四个 OEA 分栏闭环完成） | IN_PROGRESS |
