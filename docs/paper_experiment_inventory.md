...
| EXP-10 | §5.1；表 2 | caption Text-to-Audio 完整基线 | AudioCaps 975、Clotho 1,045、MECAT 847（发布 UIQ 为 848，需澄清） | 4 CLAP + 3 vanilla LALM + 6 OEA | R@1/5/10 | 六个 OEA 变体及 vanilla Nemotron-3B 在 Clotho 上均完成全量 embedding 和双协议 CPU 闭环；Nemotron all-caption=`7.2536/21.3014/30.1818`、论文=`7.20/21.57/30.12`；base-only loader/官方 metric source 且未加载 OEA checkpoint/LoRA/head | AudioCaps 实际音频、MECAT 847/caption 口径、其余 6 个 vanilla/CLAP baseline 和论文 caption 选择仍缺失 | C（七个模型的 Clotho 分栏闭环完成） | IN_PROGRESS |
| EXP-11 | §5.2；表 3 | caption Text-to-Text 完整基线 | 同 EXP-10 captions/candidates | 同 EXP-10 | R@1/5/10 | 六个 OEA/Clotho 变体及 vanilla Nemotron-3B 的 `[CODE]` seed0 与 `[INFERRED]` all-caption 均已分栏；Nemotron seed0=`57.1292/69.3780/74.3541`、all-caption=`57.8947/69.2823/74.2010`，论文=`57.84/69.36/74.26`；未按接近度择优 | 其余模型/数据；论文 caption 选择、self-exclusion、tie 口径 `[MISSING]` | C（七个模型的 Clotho 分栏闭环完成） | IN_PROGRESS |
