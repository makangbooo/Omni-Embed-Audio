...
| A-SQUTR-13B | SQuTR content audit | attempt 1 `0/1/1`；policy fix `c3c2c6f`；recovery execution commit `68aa615` | attempt 1 `logs/data13b_squtr_validation_20260726_141640`；DATA-13C `logs/data13c_squtr_content_recovery_20260726_155758`，PID `9533` | ATTEMPT_1_FAILED; RECOVERY_RUNNING |
...
| D-SQUTR-PROBE-CACHE | resumable first/last-frame audio probe cache | marker/structure/protocol/root/Git-bound | `/home/jg525/datasets/oea/squtr/manifests/.squtr_audio_probe_cache_v1.jsonl` | RUNNING_REMOTE; DATA-13C PID `9533` |
