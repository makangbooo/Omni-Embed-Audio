...
| A-SQUTR-13B | SQuTR content audit | attempt 1 `0/1/1`；attempt 2 `0/1/1`；attempt 3 execution `db7356c` | attempt 1/2 failure JSONs committed；attempt 3 `logs/data13c_squtr_content_recovery_20260726_161849`，PID `11079` | ATTEMPTS_1_2_FAILED; ATTEMPT_3_RUNNING |
...
| D-SQUTR-PROBE-CACHE-V2 | attempt-3 resumable first/last-frame audio probe cache | marker/structure/protocol/root/Git-bound | `/home/jg525/datasets/oea/squtr/manifests/.squtr_audio_probe_cache_v2.jsonl` | RUNNING_REMOTE; attempt 3 PID `11079` |
