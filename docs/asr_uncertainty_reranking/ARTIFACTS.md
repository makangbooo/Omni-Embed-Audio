...
| A-SQUTR-13B | SQuTR content audit | attempt 1 `0/1/1`；attempt 2 `0/1/1`；qrels repair `51ca79b` | attempt 1 `logs/data13b_squtr_validation_20260726_141640`；attempt 2 `logs/data13c_squtr_content_recovery_20260726_155758`；two small failure JSONs committed | ATTEMPTS_1_2_FAILED; RECOVERY_FIX_READY |
...
| D-SQUTR-PROBE-CACHE-V2 | next resumable first/last-frame audio probe cache | marker/structure/protocol/root/Git-bound | `/home/jg525/datasets/oea/squtr/manifests/.squtr_audio_probe_cache_v2.jsonl` | PENDING_REMOTE_RECOVERY |
