...
| D-SQUTR-FIQA-NQ-MANIFEST | 16,400 audio instances：FiQA 648 + NQ 3,452，四条件 | generated by DATA-13D; `record_id`/`sample_id` compatibility checked | `/home/jg525/datasets/oea/squtr/manifests/squtr_en_fiqa_nq_audio_query_manifest.jsonl` | WAITING_USER |
| D-SQUTR-FIQA-NQ-PROBE-CACHE | resumable first/last-frame target-subset audio probes | extraction marker/selected structure/protocol/root/Git-bound | `/home/jg525/datasets/oea/squtr/manifests/.squtr_audio_probe_cache_en_fiqa_nq_v1.jsonl` | WAITING_USER |
