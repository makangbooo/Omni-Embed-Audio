...
| A-SQUTR-13B | SQuTR content audit | attempt 1 `0/1/1`；policy fix `c3c2c6f`；resumable recovery `0212431` | remote `logs/data13b_squtr_validation_20260726_141640`；small failure JSON committed | ATTEMPT_1_FAILED; RECOVERY_READY |
...
| D-SQUTR-PROBE-CACHE | resumable first/last-frame audio probe cache | marker/structure/protocol/root/Git-bound | `/home/jg525/datasets/oea/squtr/manifests/.squtr_audio_probe_cache_v1.jsonl` | NOT_STARTED; generated only by DATA-13C |
