...
| A-SQUTR-13B | SQuTR content audit | attempt 1 `0/1/1`；fix `c3c2c6f` | remote `logs/data13b_squtr_validation_20260726_141640`；small failure JSON committed | ATTEMPT_1_FAILED; RECOVERY_READY |
