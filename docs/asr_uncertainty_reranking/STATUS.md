...
| 2 | Whisper 生成入口/精度三路差分 | WAITING_USER | 本提交 | tmux-only、严格离线、无正式 cache mutation；当前 generic BF16 4-best vs 官方 BF16 1-best vs 官方 FP32 1-best；每条音频记录 RMS/duration/checksum | 需要 1×RTX 4090；预计 8 条音频、5–10 分钟、峰值约 8–12 GiB | 结果若官方 BF16 正常则修复生成入口；仅 FP32 正常则正式申请精度协议变更；三路均异常则检查模型/音频接口 |
