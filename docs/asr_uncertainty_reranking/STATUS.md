...
| 1 | Nemo 5/25 OEA embedding smoke | IN_PROGRESS | 待下一提交 | 计划 1×RTX 4090 24GB；GPU 尚未启动 | 需要先验证现有生成器对 Nemo 锁、backbone 与音频 processor 的支持并提交精确 wrapper/config | 完成 CPU 静态实现和测试后申请 G1 |
