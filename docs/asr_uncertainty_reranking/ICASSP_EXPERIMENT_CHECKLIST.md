...
| OEA-B3 | SQuTR-FiQA OEA direct audio-to-text retrieval for Clean/20/10/0 dB | Primary frozen first-stage baseline and candidate generator | WAITING_USER | OEA caches remain complete; attempt 3 stopped before ranking finalization because one of 648 snr_0 Whisper records had a non-finite teacher-forced token score |
