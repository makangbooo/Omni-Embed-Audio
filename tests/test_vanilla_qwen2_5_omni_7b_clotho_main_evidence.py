...
class VanillaQwen7BClothoMainEvidenceTests(unittest.TestCase):
    @classmethod
    ...
    def test_run_is_complete_clean_timed_and_base_only(self) -> None:
        ...
        self.assertEqual(
            ...
            "5110a4ff85fb65e39b9d27ca9298aba1dae48ebe",
        )
        self.assertEqual(self.audit["run"]["elapsed_seconds"], 842)
    ...
    def test_direct_shapes_and_four_protocols_are_fixed(self) -> None:
        self.assertIn("OBSERVED", self.audit["generation"]["shape_source"])
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            ["t2a_public_code_t2a_only_seed0"]["metrics"]["R@1"],
            0.0,
        )
        self.assertEqual(
            self.audit["protocols"]
    ...
    def test_twelve_observations_bind_to_exact_audit(self) -> None:
        relevant = [
            ...
            if row["observation_id"].startswith(
                "vanilla_qwen2_5_omni_7b_clotho_"
            )
        ]
