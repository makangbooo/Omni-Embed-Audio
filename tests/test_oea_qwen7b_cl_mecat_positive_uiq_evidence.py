...
AUDIT_PATH = (
    REPOSITORY_ROOT
    / "results/audits/oea_qwen7b_cl_mecat_public848_positive_uiq_eval_20260802.json"
)


class OEAQwen7BClMecatPositiveUIQEvidenceTests(unittest.TestCase):
    @classmethod
    ...
    def test_a100_run_completed_with_official_source(self) -> None:
        ...
        self.assertEqual(self.audit["run"]["elapsed_seconds"], 412)
    ...
    def test_four_public_protocols_are_close(self) -> None:
        ...
        self.assertEqual(max(maxima), 3.298679)
        self.assertTrue(
    ...
    def test_artifacts_and_847_boundary_are_fixed(self) -> None:
        self.assertEqual(
            ...
            "7a0ab998a0531a89dade98779aea075bda2797076ad931ca402adc3047dfddb9",
        )
